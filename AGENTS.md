...
- `tests/test_juniper_chop_all.py` -- Static + hermetic full-script tests for `util/juniper_chop_all.bash` (pidfile parse, worker-filter drift, missing/empty pidfile → `orphaned_worker_cleanup` → exit 1; open #798).
