...
│   ├── test_run_suite.py                 # Behavioural: util/experiments/run_suite.py suite driver (expansion product/include/exclude + deterministic cell_ids, per_cell seeds, driver-validated materialisation, stubbed launcher/driver loop: registry/index/aggregate/teardown, continue_on_failure, resume-skip, dry-run writes nothing; hermetic)
