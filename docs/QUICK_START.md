...
- [Fail-closed `safe_conda_activate` under OR-list](REFERENCE.md#fail-closed-under-or-list-callers-open-juniper-ml976) -- plant activate must not mask failure as exit 0 (open #976)
