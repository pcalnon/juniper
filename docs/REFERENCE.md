...
│   ├── test_e2e_topology_score_contracts.py # Behavioural: M-TOPOLOGY-03 / -14 / -18 scoring (blank-heatmap FAIL, CSP-vs-environment, unreadable-store BLOCKED; hermetic, no Playwright)
