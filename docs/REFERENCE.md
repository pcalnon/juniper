...
|---------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0.6.25  | 2026-09-04 | Canopy E2E finding triage: header-only parser; ACCEPTED is a third disposition; FIXED/HEALED in the last 170 chars; `--open-only` still prints full totals; always exits 0 |
