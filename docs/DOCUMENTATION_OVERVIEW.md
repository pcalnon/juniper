...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-stack ops, agent-suite doctor, fleet triage / sequence-safety, sibling packages, and release-workflow reference |
