...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-stack ops, agent-suite doctor, fleet triage / sequence-safety, isolated/experiment stacks, sibling packages, release workflow |
