...
| **JUNIPER_2026-09-02_JUNIPER-ECOSYSTEM_PERF-LANE-P2-PLAN.md** | Plan | Perf-lane work items (split work/speed gate, Q-8 baseline, 1.5 fail-on-mismatch); operator surface in [REFERENCE](REFERENCE.md#perf-lane-metrics-and-baselines) |
