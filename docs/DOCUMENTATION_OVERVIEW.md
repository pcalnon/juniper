...
| **Understand meta TestPyPI Gate 1 verify** | [REFERENCE — Meta-Package Publish](REFERENCE.md#meta-package-publish-pipeline)                                              | docs/    |
...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-/isolated-/experiment-stack ops, meta TestPyPI Gate 1 verify, agent-suite doctor, sibling packages, release workflows |
