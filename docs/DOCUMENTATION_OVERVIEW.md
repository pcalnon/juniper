...
| **JUNIPER_2026-08-08_JUNIPER-CANOPY_E2E-CLICK-BY-CLICK-TEST-MATRIX.md**                        | Matrix      | Canopy click-by-click rows; W6 / §3.6 drivers in [REFERENCE](REFERENCE.md#canopy-e2e-dataset-drivers) |
| **JUNIPER_2026-08-09_JUNIPER-CANOPY_E2E-VALIDATION-EVIDENCE.md**                               | Ledger      | Recorded W6 / Dataset View evidence (drivers print, they do not assert) |
