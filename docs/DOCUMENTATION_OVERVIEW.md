...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-stack / isolated-stack / experiment-stack ops, agent-suite doctor, sibling packages, release workflow, and flood CI gates |
...
| **JUNIPER_2026-07-28_JUNIPER-ML_CURSOR-PR-FLOOD-REMEDIATION-ANALYSIS.md**                      | Analysis    | Cursor-fleet flood remediation design; CI gates operator surface in [REFERENCE](REFERENCE.md#flood-remediation-ci-gates) |
