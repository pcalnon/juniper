...
| **Debug CI Quality Gate / battery skip** | [REFERENCE — CI Quality Gate & Battery Path Gate](REFERENCE.md#ci-quality-gate--battery-path-gate)                            | docs/    |
...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-stack ops, CI Quality Gate / battery path-gate, agent-suite doctor, sibling packages, and release-workflow reference |
