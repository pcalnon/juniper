...
| **Understand AGENTS.md date auto-bump** | [REFERENCE — AGENTS.md Touch-Up](REFERENCE.md#agentsmd-touch-up)                                                                 | docs/    |
...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host/isolated/experiment stack ops, AGENTS.md touch-up, sibling packages, release workflows |
| **DEVELOPER_CHEATSHEET_JUNIPER-ML.md** | Cheatsheet | Quick-reference card for common development, host-stack, experiment-stack, and CI automation tasks |
