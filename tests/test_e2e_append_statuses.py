...
class AppendWriteTest(unittest.TestCase):
    ...
    def test_existing_row_is_skipped_without_replace(self) -> None:
        ...
        self._write_json([{"row_id": "M-TOPOLOGY-01", "status": "FAIL", "notes": "should-not-land"}])
    ...
    def test_replace_rewrites_in_place_keeping_position(self) -> None:
        ...
        self._write_json([{"row_id": "M-TOPOLOGY-01", "status": "PASS", "notes": "revised", "screenshots": "shot.png"}])
    ...
    def test_tab_and_newline_in_notes_stay_one_tsv_line(self) -> None:
        ...
        self._write_json([{"row_id": "M-TOPOLOGY-01", "status": "PASS", "notes": "line1\tline2\nline3"}])
