# juniper-cascor-client v0.8.0 — Release Notes (archived)

> **Archived at release time, not backfilled** — added 2026-09-05, the day the Release was cut. Unlike the
> `v0.6.0` entry beside it, the body below **is** a verbatim copy of the GitHub Release
> [`v0.8.0`](https://github.com/pcalnon/juniper-cascor-client/releases/tag/v0.8.0), which is what the
> central-archive convention asks for:
...
> The package repo keeps its own copy at `juniper-cascor-client/notes/releases/RELEASE_NOTES_v0.8.0.md`
> (cascor-client#156), identical to this body.
>
> **Known gap:** `v0.7.0` was never archived centrally — this directory jumps 0.6.0 → 0.8.0 for this
> package. That is pre-existing drift of the same kind Phase 0.3 backfilled, left flagged rather than
> silently filled in by a release PR.
