...
| APD-SVCCORE-003 | `_setting` silently defaults on a typo — including security controls | S | `websocket/control_stream.py:66-69` (13 across both copies) | 7950, 7964 | High |
...
| APD-SVCCORE-010 | `_setting` duplicated byte-identically in two modules | M | `websocket/control_stream.py:66-69`, `websocket/training_stream.py:44-47` | 7968 | High |
